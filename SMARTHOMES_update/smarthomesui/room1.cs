...
namespace smarthomesui
{
    public partial class room1 : Form
    {
        ...
        private bool UserHasExistingBooking(int userID, DateTime checkInDate, DateTime checkOutDate)
        {
            ...
            using (OleDbConnection newConn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\admin\\Documents\\smarthomesdb.accdb"))
            {
                using (OleDbCommand command = new OleDbCommand(query, newConn))
                {
