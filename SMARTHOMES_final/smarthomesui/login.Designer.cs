...
namespace smarthomesui
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.signIn.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(57)))), ((int)(((byte)(62)))), ((int)(((byte)(70)))));
            ...
            this.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(146)))), ((int)(((byte)(154)))), ((int)(((byte)(171)))));
        ...
        private OleDbConnection getUserIDConnection;

        private void button1_Click(object sender, EventArgs e)
        {
            string connectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\admin\\Documents\\smarthomesdb.accdb";
            ...
            using (var con = new OleDbConnection(connectionString))
            {
                ...
                if (dr.Read() == true)
                {
                    ...
                    getUserIDConnection = new OleDbConnection(connectionString);
                    getUserIDConnection.Open();
                    string getUserID = "SELECT UserID FROM User_table WHERE Username= @verifiedUsername";
                    cmd = new OleDbCommand(getUserID, getUserIDConnection);
