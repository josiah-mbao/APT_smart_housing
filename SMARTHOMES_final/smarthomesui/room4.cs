...
namespace smarthomesui
{
    public partial class room4 : Form
    {
        ...
        private void room3Label_Click(object sender, EventArgs e)
        {
        ...
        private void room4_Load(object sender, EventArgs e)
        {
            ...
            using (OleDbCommand command = new OleDbCommand(query, con))
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (roomID == 4)
                    {
                        room4TitleLabel.Text = roomName;
                        room4Label.Text = roomName;

                        owner4Label.Text = owner;
                        price4Label.Text = $"Ksh {price.ToString()}";
                    }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            string roomName = room4Label.Text;
            string owner = owner4Label.Text;
            decimal price = Convert.ToDecimal(price4Label.Text.Replace("Ksh ", "").Replace(" per night", ""));
        ...
        private void arrivalDate_ValueChanged_1(object sender, EventArgs e)
        {
            checkInDate = arrivalDate.Value;
        }

        private void departureDate_ValueChanged_1(object sender, EventArgs e)
        {
            checkOutDate = departureDate.Value;
        }
    }
